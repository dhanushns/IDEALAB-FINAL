                    ...
                    <form onSubmit={handleFormSubmit} className='w-100 d-flex flex-column align-items-center formscroll'>
                        <div className='formdata'>
                            <Row className='d-flex justify-content-between'>
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'><h>Student Name</h><p className='mt-1 p-1 shadows inwidth' >{formData.StudentName}</p></Col>
                        ...
                        <div className='formdata'>
                            <Row className='d-flex justify-content-between'>
                                ...
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'><h>StudentID</h><p className='mt-1 p-1 shadows inwidth' >{formData.StudentID}</p></Col>
                            </Row>
                        </div>
                        <div className='formdata'>
                            <Row className='d-flex justify-content-between'>
                                ...
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'><h>Course</h><p className='mt-1 p-1 shadows inwidth' >{formData.course.value}</p></Col>
                            </Row>
                        </div>
                        <div className='formdata'>
                            <Row className='d-flex justify-content-between'>
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'><h>Semester</h><p className='mt-1 p-1 shadows inwidth' >{formData.semester}</p></Col>
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'><h>Year of Studying</h><p className='mt-1 p-1 shadows inwidth' >{formData.yearofstudy}</p></Col>
                            </Row>
                        </div>
                        <div className='formdata'>
                            <Row className='d-flex justify-content-start'>
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'><h>Year of Graduation</h><p className='mt-1 p-1 shadows inwidth' >{formData.yearofgraduate}</p></Col>
                            </Row>
                        </div>

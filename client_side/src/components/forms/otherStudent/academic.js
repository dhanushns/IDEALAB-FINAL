                        ...
                        <div className='formdata'>
                            <Row className='d-flex justify-content-between'>
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'>
                                    <h>Student ID</h>
                                    <input className='mt-1 p-1 shadows inwidth' name='StudentID' maxLength={50} required value={formData.StudentID} onChange={getinput} /></Col>
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'>
                                    <h>Programme</h>
                            ...
                            <Row className='d-flex justify-content-between'>
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'>
                                    ...
                                    <Select
                                            ...
                                            noOptionsMessage={() => "Use Other Option"}
                                            required
                                        />
                                </Col>
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'>
                        ...
                        <div className='formdata'>
                            <Row className='d-flex justify-content-between'>
                                ...
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'>
                                    ...
                                    <input className='mt-1 p-1 shadows inwidth' name='yearofgraduate' type="number" min='1950' max='2050' required value={formData.yearofgraduate} onChange={getinput} />
                                </Col>
                            </Row>
                        </div>

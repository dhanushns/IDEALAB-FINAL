                        ...
                        <div className='w-100 d-flex flex-column align-items-center'>
                            <div className='formdata'>
                                <Row className='d-flex justify-content-between'>
                                    <Col lg={5} xs={12} className='d-flex flex-column mt-4'><h>Equipments</h><p className='mt-1 p-1 shadows inwidth' >{formData.Equipments}</p></Col>
                                    <Col lg={5} xs={12} className='d-flex flex-column mt-4'><h>Purpose</h><p className='mt-1 p-1 shadows inwidth' >{formData.Purpose}</p></Col>
                                </Row>
                            </div>
                            <div className='formdata'>
                                <Row className='d-flex justify-content-between'>
                                    <Col lg={5} xs={12} className='d-flex flex-column mt-4'><h>Reservation Date (Start)</h><p className='mt-1 p-1 shadows inwidth' >{formData.Reservationdate.toString().slice(0, 21)}</p></Col>
                                    <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'><h>Reservation Date (End)</h><p className='mt-1 p-1 shadows inwidth' >{formData.Endtime.toString().slice(0, 21)}</p></Col>

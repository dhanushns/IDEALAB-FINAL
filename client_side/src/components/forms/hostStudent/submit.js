                        ...
                        <div className='w-100 d-flex flex-column align-items-center'>
                            <div className='formdata'>
                                <Row className='d-flex justify-content-between'>
                                    <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'><h>Name</h><p className='mt-1 p-1 shadows inwidth' >{formData.Name}</p></Col>
                            ...
                            <div className='formdata'>
                                <Row className='d-flex justify-content-between'>
                                    <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'><h>Register Number</h><p className='mt-1 p-1 shadows inwidth' >{formData.registerno}</p></Col>

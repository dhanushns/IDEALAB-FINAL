                ...
                <Container fluid>
                    <Row className='backg'>
                        <Row className='text-center align-items-center m-0 p-0' style={{ height: '8vh' }}>
                            <Col sm-4 className='fonthide'>Industry Info</Col>
                            <Col sm-4 style={{ color: '#EF6C1B' }}>Industry region</Col>
                    ...
                    <form onSubmit={handleFormSubmit} className='w-100 d-flex flex-column align-items-center formscroll' >
                        <div className='formdata'>
                            <Row className='d-flex justify-content-between'>
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'>
                                    <h>Street Name</h>
                                    <input className='mt-1 p-1 shadows inwidth' name='StreetName' maxLength={250} required value={formData.StreetName} onChange={getinput} /></Col>
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'>
                                    <h>City</h>
                        ...
                        <div className='formdata'>
                            <Row className='d-flex justify-content-start'>
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'>
                                    <h>Pincode</h>
                                    <input className='mt-1 p-1 shadows inwidth' maxLength={15} name='Pincode' min='3' max='6' required value={formData.Pincode} onChange={getinput} />
                                </Col>
                            </Row>
                        </div>

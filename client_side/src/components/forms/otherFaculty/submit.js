                    ...
                    <form onSubmit={handleFormSubmit} className='w-100 d-flex flex-column align-items-center formscroll'>
                        ...
                        <div className='formdata'>
                            <Row className='d-flex justify-content-between'>
                                ...
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'><h>Institute Type</h><p className='mt-1 p-1 shadows inwidth' >{formData.InstituteType}</p></Col>
                            </Row>
                        </div>
                        <div className='formdata'>
                            <Row className='d-flex justify-content-between'>
                                ...
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'><h>AISHE Code</h><p className='mt-1 p-1 shadows inwidth' >{formData.AISHECode}</p></Col>
                            </Row>
                        </div>

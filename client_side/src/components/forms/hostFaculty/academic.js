                        ...
                        <div className='formdata'>
                            <Row className='d-flex justify-content-between'>
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'>
                                    <h>Faculty ID</h>
                                    <input className='mt-1 p-1 shadows inwidth' name='FacultyID' maxLength={25} required value={formData.FacultyID} onChange={getinput} /></Col>
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'>
                                    <h>Designation</h>
                                    <input className='mt-1 p-1 shadows inwidth' name='Designation' maxLength={200} required value={formData.Designation} onChange={getinput} />
                                </Col>
                            </Row>
                        </div>
                        <div className='formdata'>
                            <Row className='d-flex justify-content-start'>
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'>
                                    <h>Department</h>
                                    <input className='mt-1 p-1 shadows inwidth' name='Department' maxLength={250} required value={formData.Department} onChange={getinput} />
                                </Col>
                            </Row>
                        </div>

...
function EquipmentReservationTable({ handleScroll }) {
    ...
    <>
      <div class='table-content' onScroll={handleScroll}>
        <div class='column-header'>
          ...
          <div class='column-title c-2'>Equipment</div>
          <div class='column-title mf'>More info..</div>
          <div class='column-title td c-3'>Reservation Date</div>
          <div class='column-title td c-3'>End Date</div>
          <div class='column-title td c-4'>Start Time</div>
          <div class='column-title td c-5'>End Time</div>
          
          <div class='column-title td c-6'>Raw Material Requirement</div>
          <div class='column-title td c-7'>Status</div>
        </div>
        {booking.map((item, i) => (
          <div class='table-rows' key={i}>
            <div class='row-flex' id='row-flex-1'>
              <div id={`row-wrapper-${i}`} class='data-wrapper'>
                ...
                <div class='row-data rd-2 text-wrapper'>{item.equipment}</div>
                <button
                ...
                <div class='row-data rd-3 td text-wrapper'>{item.inTime.slice(0, 10)}</div>
                <div class='row-data rd-3 td text-wrapper'>{item.outTime.slice(0, 10)}</div>
                <div class='row-data rd-4 td text-wrapper'>{item.inTime.slice(11, 16)}</div>
                <div class='row-data rd-5 td text-wrapper'>{item.outTime.slice(11, 16)}</div>
                
                <div class='row-data c-6 td text-wrapper'>{item.rawMaterialRequirement}</div>
                ...
                <div class='expanded-content'>
                  ...
                  <div class='ex-col-1 ex-cols'>
                    <div class='row-wrapper r1'>
                      <div class='r1-name'>Equipment</div>
                      <div class='colon'>:</div>
                      <div class='r1-data'>{item.equipment}</div>
                    </div>
                    <div class='row-wrapper r2'>
                      <div class='r1-name'>In Time</div>
                      <div class='colon'>:</div>
                      <div class='r1-data'>{item.inTime.slice(11, 16)}</div>
                    </div>
                  ...
                  <div class='ex-col-2 ex-cols'>
                    <div class='row-wrapper r1'>
                      <div class='r1-name'>Raw Material Requirement</div>
                      <div class='colon'>:</div>
                      <div class='r1-data'>{item.rawMaterialRequirement}</div>
                    </div>

                    <div class='row-wrapper r3'>
                      <div class='r1-name'>Reservation Date and Time</div>
                      <div class='colon'>:</div>
                      <div class='r1-data'>
                        {item.inTime.slice(0, 10)} <br></br>{item.inTime.slice(11, 16)}
                      </div>
                    </div>
                    <div class='row-wrapper r4'>
                      <div class='r1-name'>Reservation End Date and Time</div>
                      <div class='colon'>:</div>
                      <div class='r1-data'>
                        {item.outTime.slice(0, 10)} <br></br>{item.outTime.slice(11, 16)}
                      </div>
                    </div>
                  </div>
                </div>

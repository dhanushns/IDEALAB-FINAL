...
function DisplayProfileInformation () {
  ...
  return (
    <>
      <div class='title-header'>
        <div class='text-wrapper'>Entrepreneur Information</div>
      </div>
      <div class='flex-1' id='display-flex-1'>
        ...
        <div class='flex-col-2'>
          <div class='groups grp3'>
            <div class='term text-wrapper'>E-Mail</div>
            <div class='colon text-wrapper'>:</div>
      ...
      <div class='title-header'>
        <div class='text-wrapper'>Entrepreneur Region</div>
      </div>
      <div class='flex-2' id='display-flex-2'>
        ...
        <div class='flex-col-2'>
          ...
          <div class='groups grp5'>
            ...
            <div class='colon text-wrapper'>:</div>
            <div class='description text-wrapper'>{userInformation.pincode}</div>
          </div>
        </div>
      </div>
          ...
          <div class='top-content'>
            <div class='profile'>
              ...
              <div class='wrapper-2 user-id'>
                ...
                <div class='title text-wrapper'>Entrepreneur</div>
              </div>
            </div>
            {/* {profilePage !== 0 && (
              <>

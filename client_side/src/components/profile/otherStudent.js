  ...
  return (
    <>
      ...
      <div class='flex-1' id='display-flex-1'>
        <div class='flex-col-1'>
          <div class='groups grp1'>
            <div class='term text-wrapper'>Student ID</div>
            <div class='colon text-wrapper'>:</div>
            <div class='description text-wrapper'>{userInformation.studentId}</div>
          </div>
          <div class='groups grp2'>
        ...
        <div class='flex-col-1'>
          <div class='groups grp1'>
            <div class='term text-wrapper'>Year of Studying</div>
            <div class='colon text-wrapper'>:</div>
        ...
        <div class='flex-col-2'>
          <div class='groups grp3'>
            ...
            <div class='colon text-wrapper'>:</div>
            <div class='description text-wrapper'>{userInformation.yearOfGraduation}</div>
          </div>
        </div>
      </div>

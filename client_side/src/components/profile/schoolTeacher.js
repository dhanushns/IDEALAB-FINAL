  ...
  return (
    <>
      ...
      <div class='flex-2' id='display-flex-2'>
        <div class='flex-col-1'>
          <div class='groups grp1'>
            <div class='term text-wrapper'>Teacher ID</div>
            <div class='colon text-wrapper'>:</div>
            <div class='description text-wrapper'>{userInformation.teacherId}</div>
          </div>
          <div class='groups grp3'>
            <div class='term text-wrapper'>UDISE Code</div>
            <div class='colon text-wrapper'>:</div>
            <div class='description text-wrapper'>{userInformation.udiseCode}</div>
          </div>
        </div>
        <div class='flex-col-2'>
          <div class='groups grp5'>

    ...
    <>
      ...
      <div class='flex-2' id='display-flex-2'>
        <div class='flex-col-1'>
          ...
          <div class='groups grp3'>
            <div class='term text-wrapper'>Address</div>
            <div class='colon text-wrapper'>:</div>
            <div class='description text-wrapper'>{userInformation.address}</div>
          </div>
        </div>
        <div class='flex-col-2'>
          <div class='groups grp4'>
      ...
      <div class='flex-1' id='display-flex-1'>
        <div class='flex-col-1'>
          <div class='groups grp1'>
            <div class='term text-wrapper'>Institute Name</div>
            <div class='colon text-wrapper'>:</div>
            <div class='description text-wrapper'>{userInformation.InstituteName}</div>
          </div>
          <div class='groups grp2'>
            <div class='term text-wrapper'>Course</div>
            <div class='colon text-wrapper'>:</div>
            <div class='description text-wrapper'>{userInformation.course}</div>
          </div>
        </div>
        <div class='flex-col-2'>
          <div class='groups grp3'>
            <div class='term text-wrapper'>Programme</div>
            <div class='colon text-wrapper'>:</div>
            <div class='description text-wrapper'>{userInformation.programme}</div>
          </div>
          <div class='groups grp2'>
            <div class='term text-wrapper'>Year of passing</div>
            <div class='colon text-wrapper'>:</div>
            <div class='description text-wrapper'>{userInformation.yearOfPassing}</div>
          </div>
        </div>
      </div>
          ...
          <div class='top-content'>
            <div class='profile'>
              ...
              <div class='wrapper-2 user-id'>
                ...
                <div class='title text-wrapper'>Alumini</div>
              </div>
            </div>
            {/* {profilePage !== 0 && (
              <>

...
function ScheduleVisitTable({ handleScroll }) {
    ...
    useEffect(() => {
        setvisit(JSON.parse(localStorage.getItem('value')).visit);
    }, []);
    ...
    function passStatus(status) {
        axios.post("/admin", { work: 'process', id: passingValue, status, table: "visit" })
            .catch(err => {
                console.log(err);
            });
    }
            ...
            <div class='db-modal'>
                ...
                <div class='db-content'>
                    <div className='d-flex flex-wrap mt-2 mb-2 justify-content-between'>
                        <div style={{ fontSize: '20px', color: "#fff" }}>Schedule Visit</div>
                        <div>
                                ...
                                <>
                                    <div class='table-content' onScroll={handleScroll}>
                                        <div class='column-header'>
                                            ...
                                            <div class='column-title td c-3'>Date Of Visit</div>
                                            
                                            <div class='column-title td c-5'>purpose</div>
                                            <div class='column-title td c-6'>Accommodation</div>
                                            <div class='column-title td c-4'>No Of Days</div>
                                            <div class='column-title td c-7'>No Of Visitors</div>
                                                ...
                                                <div class='table-rows' key={i}>
                                                    <div class='row-flex' id={`row-flex-${i}`}>
                                                        <div id={`row-wrapper-${i}`} class='data-wrapper'>
                                                            ...
                                                            <div class='row-data rd-3 td text-wrapper'>{item.DateOfVisit}</div>
                                                            <div class='row-data rd-4 td text-wrapper'>{item.numberOfDays}</div>
                                                            <div class='row-data rd-5 td text-wrapper'>{item.purpose}</div>
                                                            <div class='row-data rd-6 td text-wrapper'>{item.accommodation}</div>
                                                            <div class='row-data c-7 td text-wrapper'>{item.noOfVisitors}</div>
                                                        ...
                                                        <div class='rows-expand' id={`handle-row-${i}`}>
                                                            ...
                                                            <div class='expanded-content'>
                                                                ...
                                                                <div class='ex-col-1 ex-cols'>
                                                                    ...
                                                                    <div class='row-wrapper r1'>
                                                                        <div class='r1-name'>Date Of Visit</div>
                                                                        <div class='colon'>:</div>
                                                                        <div class='r1-data'>{item.DateOfVisit}</div>
                                                                    </div>
                                                                    <div class='row-wrapper r1'>
                                                                        <div class='r1-name'>Exit Visit</div>
                                                                        <div class='colon'>:</div>
                                                                    ...
                                                                    <div class='row-wrapper r1'>
                                                                        <div class='r1-name'>Accommodation</div>
                                                                        <div class='colon'>:</div>
                                                                        <div class='r1-data'>{item.accommodation}</div>
                                                                    </div>
                                                                </div>
                                                                <div class='ex-col-2 ex-cols'>
                                                                    ...
                                                                    <div class='row-wrapper r1'>
                                                                        <div class='r1-name'>Check In Time</div>
                                                                        <div class='colon'>:</div>
                                                                        <div class='r1-data'>{item.chickInTime}</div>
                                                                    </div>
                                                                    <div class='row-wrapper r1'>
                                                                        <div class='r1-name'>Check Out Time</div>
                                                                        <div class='colon'>:</div>
                                                                        <div class='r1-data'>{item.checkOutTime}</div>
                                                                    </div>

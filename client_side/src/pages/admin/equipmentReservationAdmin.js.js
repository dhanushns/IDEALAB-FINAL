...
function ScheduleVisitTable({ handleScroll }) {
    ...
    useEffect(() => {
        setbooking(JSON.parse(localStorage.getItem('value')).booking);
    }, []);
    ...
    function passStatus(status) {
        axios.post("/admin", { work: 'process', id: passingValue, status, table: "booking" })
            .catch(err => {
                console.log(err);
            });
    }
            ...
            <div class='db-modal'>
                ...
                <div class='db-content'>
                    <div className='d-flex flex-wrap mt-2 mb-2 justify-content-between'>
                        <div style={{ fontSize: '20px', color: "#fff" }}>Equipment Reservation</div>
                        <div>
                                ...
                                <>
                                    <div class='table-content' onScroll={handleScroll}>
                                        <div class='column-header'>
                                            ...
                                            <div class='column-title td c-3'>Equipment</div>
                                            <div class='column-title td c-4'>In Time</div>
                                            <div class='column-title td c-5'>Out Time</div>
                                            <div class='column-title td c-6'>purpose</div>
                                            <div class='column-title td c-7'>Raw Material Requirement</div>
                                                ...
                                                <div class='table-rows' key={i}>
                                                    <div class='row-flex' id={`row-flex-${i}`}>
                                                        <div id={`row-wrapper-${i}`} class='data-wrapper'>     
                                                            ...
                                                            <div class='row-data rd-3 td text-wrapper'>{item.equipment}</div>
                                                            <div class='row-data rd-4 td text-wrapper'>{item.inTime}</div>
                                                            <div class='row-data rd-5 td text-wrapper'>{item.outTime}</div>
                                                            <div class='row-data rd-6 td text-wrapper'>{item.purpose}</div>
                                                            <div class='row-data c-7 td text-wrapper'>{item.rawMaterialRequirement}</div>
                                                            ...
                                                            <div class='expanded-content'>
                                                                ...
                                                                <div class='ex-col-1 ex-cols'>
                                                                    ...
                                                                    <div class='row-wrapper r2'>
                                                                        ...
                                                                        <div class='colon'>:</div>
                                                                        <div class='r1-data'>{item.inTime}</div>
                                                                    </div>
                                                                    <div class='row-wrapper r3'>
                                                                        <div class='r1-name'>Out Time</div>
                                                                        <div class='colon'>:</div>
                                                                        <div class='r1-data'>
                                                                            {item.outTime}
                                                                        </div>
                                                                ...
                                                                <div class='row-wrapper r1'>
                                                                        ...
                                                                        <div class='colon'>:</div>
                                                                        <div class='r1-data'>{item.purpose}</div>
                                                                    </div>
                                                                    <div class='row-wrapper r2 '>

      ...
      <div class='flex-1' id='display-flex-1'>
        ...
        <div class='flex-col-2'>
          <div class='groups grp3'>
            ...
            <div class='colon text-wrapper'>:</div>
            <div class='description text-wrapper'>{userInformation.designation}</div>
          </div>
          <div class='groups grp2'>
            <div class='term text-wrapper'>Institute Type</div>
            <div class='colon text-wrapper'>:</div>
            <div class='description text-wrapper'>{userInformation.InstituteType}</div>
          </div>
        </div>
        <div class='flex-col-1'>
          <div class='groups grp1'>
        ...
        <div class='flex-col-2'>
          <div class='groups grp3'>
            <div class='term text-wrapper'>AISHE Code</div>
            <div class='colon text-wrapper'>:</div>
            <div class='description text-wrapper'>{userInformation.aisheCode}</div>
          </div>
        </div>
      </div>
